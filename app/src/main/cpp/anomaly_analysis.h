...
typedef enum {
    ...
    ANOMALY_TIMING_STAGE_COLOR_SEED_SCORING = 8,
    ANOMALY_TIMING_STAGE_COLOR_BLOB_EXTRACTION = 9,
    ANOMALY_TIMING_STAGE_COLOR_CANDIDATE_RANKING = 10,
    ANOMALY_TIMING_STAGE_MOTION_SCORING = 11,
    ANOMALY_TIMING_STAGE_SALIENCY_SCORING = 12,
    ANOMALY_TIMING_STAGE_TARGET_TRACKING = 13,
    ANOMALY_TIMING_STAGE_OVERLAY_DRAW = 14,
    ANOMALY_TIMING_STAGE_COUNT = 15,
